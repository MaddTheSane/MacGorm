...
*/
func NSDebugLLog(_ level: String, _ format: String, args: [CVarArg]) {
	if GSDebugSet(level) {
...
func NSDebugFLLog(_ level: String, file: String = #file, line: Int32 = #line, function: String = #function, _ format: String, args: CVarArg...) {
	if GSDebugSet(level) {
