...
- (id) init
{
  ...
  if ([NSBundle loadNibNamed: @"GormDrawerAttributesInspector" owner: self] == NO)
    {
      NSLog(@"Could not gorm GormDrawerAttributesInspector");
      return nil;
    }
...
- (void) ok: (id) sender
{
  ...
  [drawer setPreferredEdge: [[sender selectedItem] tag]];
}
